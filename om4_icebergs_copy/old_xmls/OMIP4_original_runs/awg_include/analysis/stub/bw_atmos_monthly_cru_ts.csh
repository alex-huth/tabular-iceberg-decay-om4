#!/bin/csh -f
#------------------------------------
#PBS -N bw_atmos_cru_monthly_timeseries
#PBS -l size=1
...
# monthly temp, precip, cld amt
$FRE_CODE_BASE/$PACKAGE_NAME/runscript.pl $options -t mean,stdev,trend -v tas
$FRE_CODE_BASE/$PACKAGE_NAME/runscript.pl $options -t mean -v pr
$FRE_CODE_BASE/$PACKAGE_NAME/runscript.pl $options -t mean -v clt
