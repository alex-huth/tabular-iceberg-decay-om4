...
#PBS -q batch
#----------------------------------
# Script: bw_cru_temp.csh
# Author: Bruce Wyman
# Source data: pp/atmos/ts/3hr
...
set PACKAGE_NAME = bw_diurnal_precip
...
set options = "-i $in_data_dir -d $descriptor -o $out_dir -y $yr1,$yr2 -c $databegyr,$dataendyr,$datachunk -g $staticfile"

$FRE_CODE_BASE/$PACKAGE_NAME/bw_diurnal_precip_driver.pl $options
