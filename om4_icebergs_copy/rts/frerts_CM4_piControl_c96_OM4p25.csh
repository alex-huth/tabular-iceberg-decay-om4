...
XML_FILE=CM4_piControl_c96_OM4p25.xml               #The xml to test
RELEASE='2019.01.03'         #The FMS release to test
MOM6_DATE='20201120'                     #The MOM6 tag date to test
...
EXPERIMENT_LIST="CM4_piControl_c96_OM4p25"
...
#FRERTS_ARGS="--compile,--no_rts,--res_num,3,--fre_ops,-r;basic;-u;--no-transfer,--do_frecheck,--reference_tag,${REFERENCE_TAG}" 
